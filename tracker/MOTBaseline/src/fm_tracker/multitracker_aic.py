...
class FairTracker(object):
    ...
    def update(self, detects, features, frame_id):
        ...
        # # dists = matching.fuse_score(dists, detections) # Whether to integrate confidence
        ...
        output_stracks = [track for track in self.tracked_stracks if track.is_activated]   # Prediction is not output
        # output_stracks = [track for track in self.tracked_stracks if track.is_activated] \
        #                    + [track for track in self.lost_stracks if (track.state == TrackState.Lost and track.frame_id - track.end_frame < self.max_time_lost)]   # Predict output
